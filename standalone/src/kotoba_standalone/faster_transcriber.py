...
from kotoba_standalone.transcriber import TranscriptionDependencyError, TranscriptionResult, read_wav_mono_float32
    ...
    def load(self) -> None:
        try:
            ...
            raise TranscriptionDependencyError(
                ...
                "Run 'uv sync --group transcribe --group cuda --group pyannote --group faster', then retry."
            ) from exc
