...
def test_clamp_subtitle_timings_limits_end_and_drops_late_chunks() -> None:
    chunks = clamp_subtitle_timings(
        [
            SubtitleChunk(11.0, 12.2, "keep"),
            SubtitleChunk(12.1, 13.0, "drop"),
        ],
        12.0,
    )

    assert chunks == [SubtitleChunk(11.0, 12.0, "keep")]
